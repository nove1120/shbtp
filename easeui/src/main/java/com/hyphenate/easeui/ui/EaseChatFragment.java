...
//        titleBar.setTitle("会话");
        final SharedPreferences sharedPreferences = getActivity().getSharedPreferences("chatusername",Context.MODE_PRIVATE);
        String realUserName = sharedPreferences.getString("es"+toChatUsername,"");
        ...
        String url = serverUrl + "/getUserName";
        OkHttpUtils
                .post()
                .url(url)
                .addParams("uid", toChatUsername)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        titleBar.setTitle(response);
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.putString("es"+toChatUsername,response);
                    }
                });
